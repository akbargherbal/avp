...
const AlgorithmTracePlayer = () => {
  ...
  // 1. Data Loading Hook (now uses Context)
  ...
  const nextStep = () => {
    ...
    const wasPredictionActivated =
      prediction.activatePredictionForStep(nextStepIndex);
  ...
  useKeyboardShortcuts({
    ...
    modalOpen:
      prediction.showPrediction || showAlgorithmInfo || showCompletionModal,
